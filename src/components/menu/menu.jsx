...
export default function Menu () {
    ...
    return(
        <div className="h-full px-5 py-5 overflow-y-auto bg-gray-100 rounded-2xl">
            {
                session?.user?.roles &&
                <ul className="space-y-2 py-2 font-medium border-b border-gray-200">
                    <li>
                        <a href="/dashboard" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="/perfil" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                        <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {
                        (session?.user?.roles === 'admin' || session?.user?.roles === 'superadmin') &&
                        <li>
                            <a href="/usuarios" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    }
                    {
                        ...
                        <li>
                            <a href="/pacientes" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    }
                    {
                        (session?.user?.roles === 'admin' || session?.user?.roles === 'superadmin')  &&
                        <li>
                            <a href="/roles" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    }
                    {
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 group">
                            <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="py-2 font-medium">
                <li onClick={cerrarSesion}>
                    <span className="flex items-center p-2 text-gray-500 hover:text-gray-900 rounded-lg hover:bg-gray-200 hover:cursor-pointer group">
