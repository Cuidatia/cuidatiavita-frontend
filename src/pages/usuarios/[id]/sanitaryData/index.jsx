    ...
    return(
        <PacienteLayout mostrarPaciente={mostrarPaciente}>
            <div className="py-4 px-4">
                ...
                <div className="py-4 space-y-4 overflow-y-scroll max-h-[calc(100vh-220px)] mt-6">
                    <div>
                        <label htmlFor="mainIllness" className="block mb-2 text-sm font-medium text-gray-900">Diagnóstico principal</label>
                        <textarea name="mainIllness" id="mainIllness" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" disabled></textarea>
                    </div>
                    <div>
                        <label htmlFor="allergies" className="block mb-2 text-sm font-medium text-gray-900">Alergias</label>
                        <textarea name="allergies" id="allergies" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" disabled></textarea>
                    </div>
                    <div>
                        <label htmlFor="otherIllness" className="block mb-2 text-sm font-medium text-gray-900">Otros trastornos</label>
                        <textarea name="otherIllness" id="otherIllness" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" disabled></textarea>
                    </div>
                </div>
            </div>
        </PacienteLayout>
