        ...
        <PacienteLayout mostrarPaciente={mostrarPaciente} page={"0"}>
            <div className="py-2 space-y-8">
                ...
                <div>
                    ...
                    />
                    {session?.user?.roles.split(',').includes('superadmin','administrador') && (
                        <Card
                ...
                {(session?.user?.roles.split(',').includes('medico/enfermero') || session?.user?.roles.split(',').includes('superadmin','administrador') || session?.user?.roles.split(',').includes('trabajador social') || session?.user?.roles.split(',').includes('educador social/terapeuta ocupacional')) && (
                    <div>
